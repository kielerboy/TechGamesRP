...
const camerasManager = require('./TechGames/ragelife/camera.js');
const objects = require('./TechGames/ragelife/objects.js');
...
mp.events.add("client:progressbar:start", (percentage, duration) => {
    ...
    browser = mp.browsers.new('package://TechGames/progressbar/index.html');
...
mp.events.add({
    ...
    "startDeathScreen": () => {
        if (browser !== null) browser.destroy();
        browser = mp.browsers.new('package://TechGames/deathscreen/index.html');
    ...
    "createBank": () => {
        ...
        bank = mp.browsers.new("package://TechGames/BankVertrag/index.html");
        mp.gui.chat.show(false);
    ...
    "createInput": (trigger) => {
        ...
        input = mp.browsers.new("package://TechGames/input/input.html");
    ...
    "noosenachricht": () => {
        ...
        audio = mp.browsers.new("package://TechGames/IAATower/index2.html");
    },
    ...
    "createInputHouse": (trigger) => {
        ...
        inputHouse = mp.browsers.new("package://TechGames/inputHouse/input.html");
    ...
    "createInputRechnung": (trigger) => {
        ...
        inputRechnung = mp.browsers.new("package://TechGames/inputRechnung/input.html");
    ...
    "createTargetRechnung": (player, output, text) => {
        ...
        acceptRechnung = mp.browsers.new("package://TechGames/inputRechnung/input.html");
    ...
    "createInputShop": (trigger, button) => {
        ...
        inputShop = mp.browsers.new("package://TechGames/inputShop/input.html");
    ...
    "createMenu": (triggerName, menuName, menuItemList) => {
        if (browser !== null || input !== null) return;
        browser = mp.browsers.new('package://TechGames/menu/index.html');
    ...
    "startLogin": (username) => {
        ...
        browser = mp.browsers.new('package://TechGames/login/index.html');
    ...
    "loginFinish": (money) => {
        ...
        hud = mp.browsers.new("package://TechGames/hud/index.html");
