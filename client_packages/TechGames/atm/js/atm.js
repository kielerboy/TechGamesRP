...
var app = new Vue({
    ...
    data: {
        accounts: [
            { IBAN: 'DE22760501014572930875', BIC: 'SSKNDE77XXX', balance: 0.00 }
        ],
        transfers: [
...
function checker(id) {
    if (id == 1) {
        var id1 = "auszahleninhalt"; var type = "Ausgezahlt"; var id2 = "auszahlenstatus"; var money = document.getElementsByClassName("a-count")[0].value + "$";
    ...
    if (id == 2) {
        var id1 = "einzahleninhalt"; var type = "Eingezahlt"; var id2 = "einzahlenstatus"; var money = document.getElementsByClassName("e-count")[0].value + "$";
    ...
    if (id == 3) {
        var id1 = "ueberweiseninhalt"; var type = "Überwiesen"; var id2 = "ueberweisenstatus"; var money = document.getElementsByClassName("t-count")[0].value + "$"; var iban = document.getElementsByClassName("t-number")[0].value;
        document.getElementsByClassName("überdecken1")[0].style.display = "block";
        document.getElementsByClassName("überdecken2")[0].style.display = "block";
