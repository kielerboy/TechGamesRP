...
mp.events.add("client:police:leitstellensystem", (link) => {
    if (akten == null) {
      akten = mp.browsers.new('package://TechGames/Police/Leitstelle/index.html');
...
mp.events.add("client:police:showIDCard", (playerName,rankName) => {
  if (idcarddocument == null) {
    idcarddocument = mp.browsers.new('package://TechGames/Dokumente/dienstausweis_police.html');
